    ...
    <div style="display: flex; justify-content: space-between; height: 350px">
      ...
      <div style="width: 24%">
        <el-card shadow="never" style="border-radius: 15px">
          ...
          <RouterLink to="/kpi/KpiScore"> <div id="EchartDashBoard" style="height: 250px"></div></RouterLink>
        </el-card>
      </div>
      <!-- 奖金系数大于120%人员 -->
      <div style="width: 24%">
            ...
            <el-table :data="bonusCoefficientData" height="250px"
              ...
              ><el-table-column :label="$t('userName')" prop="userName">
                <template #default="scope">
                  <router-link to="/kpi/KpiScore" style="text-decoration: none; color: #606260">
