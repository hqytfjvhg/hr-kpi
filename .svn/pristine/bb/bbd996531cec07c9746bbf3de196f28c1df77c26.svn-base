<template>
  <div class="performanceTable">
    <!-- 此页面没有被使用 -->
    <div class="performanceTableTitle">查询部门业绩得分</div>
    <el-form :rules="rules">
...
<script>
import { getPermanceDeptScore } from "@/api/performance/index";
