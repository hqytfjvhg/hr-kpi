<template>
  <div>
    ...
    <div style="display: flex; justify-content: space-between">
      <div style="border-radius: 10px; background-color: #fff; display: flex; width: 70%; border: 1px solid #ebeef5">
        <div style="width: 50%">
          <div
            style="
          ...
          <div v-if="$store.state.number2 - $store.state.number > 0" class="ulStyle">
            <span
              ><el-icon style="color: #e6a23c"><WarningFilled /></el-icon
              ><span style="margin-left: 1vw">请审批业绩指标</span>
            </span>
          ...
          <div v-if="signNumber > 0" class="ulStyle">
            <span
              ><el-icon style="color: #e6a23c"><WarningFilled /></el-icon
              ><span style="margin-left: 1vw">请确认绩效月考评表</span>
            </span>
      ...
      <div style="width: 28%">
        <el-card style="text-align: left; border-radius: 10px; height: 100%" shadow="never">
          <template #header>
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 15px">
      <div style="width: 100%">
        <el-card style="text-align: left; border-radius: 10px" shadow="never">
          ...
          <div v-if="xAxisOneYear.length == 0">暂无数据</div>
          <div id="EChartAllYearKPI" style="width: 100%; height: 300px"></div>
        </el-card>
      </div>
      <!-- <div style="width: 28%" v-if="$store.state.role == 'CLERK'">
        <el-card style="text-align: left; border-radius: 10px; height: 100%" shadow="never">
          <template #header>
            <div class="card-header">
              <span>未填写价值观名单</span>
          ...
          <div>
            <el-table :data="noWriteValueList" height="300px">
...
import { getSelfPerformanceInfo, getOneselfAllYear } from "@/api/visualization/index";
...
export default {
  ...
  async mounted() {
    ...
    // if (this.$store.state.role == "CLERK") {
