  ...
  <div class="targetlist">
    <el-tabs v-model="activeName" class="demo-tabs">
      <el-tab-pane label="指标列表" name="target">
        <el-table :data="targetList1" border :height="tableHeight" type="index" class="table-target">
          ...
          <el-table-column label="计算方法" prop="calculationMethod" width="200"></el-table-column>
          <el-table-column prop="dataProvider" label="数据提供人" width="100" />
          <el-table-column prop="reportSource" label="报表源" />
          <el-table-column label="考核区间" align="center" prop="targetScoreList" width="850">
      ...
      <el-tab-pane label="绩效奖金核算方法" name="bouns">
        <el-table :data="bounsCoefficientList" border :height="tableHeight" type="index" class="table-bouns">
...
:deep(.table-target .el-table__cell.is-center) {
  text-align: left;
  font-size: 12px;
}
