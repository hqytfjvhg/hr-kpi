<template>
  <div class="loglist">
    <div class="logRefresh">
      <el-button @click="getLogDoc()" type="primary">
        <el-icon style="padding-right: 5px"><Refresh /></el-icon>{{ $t("refresh") }}</el-button
      >
    </div>
...
export default {
  components: { Delete, Download, Refresh },
  data() {
    return {
      allData: [],
      logDocList: [],
