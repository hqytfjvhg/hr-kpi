  ...
  <div>
    ...
    >
      <el-timeline style="text-align: left">
        ...
        >
          {{ activity.content }}
          <el-button v-if="index == 0" @click="dialogUser = true" size="small" type="primary">选择参与人员</el-button>
          <div v-if="userSelectName && index == 0" class="select-tooltip">
          ...
          <el-table v-if="index == 1" :data="deptNameList" class="table-style" border row-style="height:60px">
