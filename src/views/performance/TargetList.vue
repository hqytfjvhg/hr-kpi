<template>
  <div class="targetlist">
    <div class="form-style">
      ...
      <el-button @click="selectTargetByDept" type="primary">{{ $t("inquire") }}</el-button>
      <el-tooltip content="新增指标" placement="top" effect="light" v-if="!isRootRead && !isRootDown">
    ...
    <el-table :data="targetList1" border :height="tableHeight" style="width: 100%; text-align: center" type="index">
      ...
      <el-table-column label="计算方法" prop="calculationMethod" min-width="120"></el-table-column>
      ...
      <el-form :model="formData" :rules="rules" label-width="120px">
        ...
        <el-form-item label="指标区间" prop="score" v-if="title !== '修改信息'">
          <el-table :data="targetScoreScopePos" style="width: 250px">
            ...
            <el-table-column label="区间最小值" prop="min">
              <template #default="scope">
                <el-input v-model="scope.row.min"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="区间最大值" prop="max">
              <template #default="scope">
        ...
        <div style="text-align: right">
          <el-button @click="isAddTarget = false">{{ $t("cancle") }}</el-button>
          <el-button
            type="primary"
            @click="submitForm"
            v-if="(title == '新增指标' || edit) && !isRootRead && !isRootDown"
            >{{ $t("confirm") }}</el-button
          >
          <el-button
            type="primary"
            @click="submitTargetInfo"
            v-if="title == '修改信息' && formData.edit && !isRootRead && !isRootDown"
            >{{ $t("confirm") }}</el-button
          >
        </div>
      </el-form>
